...
int main(int argc, char **argv)
{
        ...
        if (argc == 2) {
                ...
                sprintf(testfile, "fixtures/input1.txt");
        }
        ...
        print_master("Make sure that you call this test program from the root\n"\
                     "directory that contains the directory 'fixtures',\n"\
                     "unless you specify your own test files.\n");
        print_master("\n");
