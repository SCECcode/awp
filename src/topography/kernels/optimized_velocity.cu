...
#define _u3(i, j, k)                                                   \
        ...
        float rho3 =
            phy4[2] *
                (phx4[2] * _rho(i, j, k) + phx4[0] * _rho(i - 2, j, k) +
        ...
        _u3(i, j, k) =
            (a * _u3(i, j, k) +
             Ai3 * (dhy4[2] * _f_2(i, j) * _g3(k) * _s23(i, j, k) +
...
#define _u3(i, j, k)                                                   \
        u3[(k) + align +                                               \
           (2 * align + nz) * ((i) + ngsl + 2) * (2 * ngsl + ny + 4) + \
           (2 * align + nz) * ((j) + ngsl + 2)]
        float rho1 = phz4[0] * (phy4[2] * _rho(i, j, k + 4) +
                                phy4[0] * _rho(i, j - 2, k + 4) +
                                phy4[1] * _rho(i, j - 1, k + 4) +
                                phy4[3] * _rho(i, j + 1, k + 4)) +
                     phz4[1] * (phy4[2] * _rho(i, j, k + 5) +
                                phy4[0] * _rho(i, j - 2, k + 5) +
                                phy4[1] * _rho(i, j - 1, k + 5) +
                                phy4[3] * _rho(i, j + 1, k + 5)) +
                     phz4[2] * (phy4[2] * _rho(i, j, k + 6) +
                                phy4[0] * _rho(i, j - 2, k + 6) +
                                phy4[1] * _rho(i, j - 1, k + 6) +
                                phy4[3] * _rho(i, j + 1, k + 6)) +
                     phz4[3] * (phy4[2] * _rho(i, j, k + 7) +
                                phy4[0] * _rho(i, j - 2, k + 7) +
                                phy4[1] * _rho(i, j - 1, k + 7) +
                                phy4[3] * _rho(i, j + 1, k + 7));
        float rho2 = phz4[0] * (phx4[2] * _rho(i, j, k + 4) +
                                phx4[0] * _rho(i - 2, j, k + 4) +
                                phx4[1] * _rho(i - 1, j, k + 4) +
                                phx4[3] * _rho(i + 1, j, k + 4)) +
                     phz4[1] * (phx4[2] * _rho(i, j, k + 5) +
                                phx4[0] * _rho(i - 2, j, k + 5) +
                                phx4[1] * _rho(i - 1, j, k + 5) +
                                phx4[3] * _rho(i + 1, j, k + 5)) +
                     phz4[2] * (phx4[2] * _rho(i, j, k + 6) +
                                phx4[0] * _rho(i - 2, j, k + 6) +
                                phx4[1] * _rho(i - 1, j, k + 6) +
                                phx4[3] * _rho(i + 1, j, k + 6)) +
                     phz4[3] * (phx4[2] * _rho(i, j, k + 7) +
                                phx4[0] * _rho(i - 2, j, k + 7) +
                                phx4[1] * _rho(i - 1, j, k + 7) +
                                phx4[3] * _rho(i + 1, j, k + 7));
...
#define _u3(i, j, k)                                                   \
        ...
        _u3(i, j, nz - 1 - k) =
            (a * _u3(i, j, nz - 1 - k) +
             Ai3 * (dhy4[2] * _f_2(i, j) * _g3(nz - 1 - k) *
                        _s23(i, j, nz - 1 - k) +
            ...
            (a * _u2(i, j + rj0, k) +
             Ai2 *
                 (dhz4l[k][0] * _s23(i, j + rj0, 0) +
                  ...
                  dx4[0] * _f(i - 1, j + rj0) * _g3_c(k) *
                      _s12(i - 1, j + rj0, k) +
                  dx4[2] * _f(i + 1, j + rj0) * _g3_c(k) *
                      _s12(i + 1, j + rj0, k) +
                  dx4[3] * _f(i + 2, j + rj0) * _g3_c(k) *
                      _s12(i + 2, j + rj0, k) +
            ...
            (a * _u3(i, j + rj0, k) +
             Ai3 *
                 (dhy4[2] * _f_2(i, j + rj0) * _g3(k) * _s23(i, j + rj0, k) +
                  ...
                  dx4[0] * _f_1(i - 1, j + rj0) * _g3(k) *
                      _s13(i - 1, j + rj0, k) +
                  dx4[2] * _f_1(i + 1, j + rj0) * _g3(k) *
                      _s13(i + 1, j + rj0, k) +
                  dx4[3] * _f_1(i + 2, j + rj0) * _g3(k) *
                      _s13(i + 2, j + rj0, k) +
...
#define _u3(i, j, k)                                                   \
        ...
        float rho3 =
            phy4[2] * (phx4[2] * _rho(i, j + rj0, nz - 1 - k) +
