...
#define _u3(i, j, k)                                                   \
        ...
        float rho1 =
            ...
            phz2l[k][1] *
                (phy2[1] * _rho(i, j, 1) + phy2[0] * _rho(i, j - 1, 1)) +
            phz2l[k][2] *
                (phy2[1] * _rho(i, j, 2) + phy2[0] * _rho(i, j - 1, 2)) +
            phz2l[k][3] *
                (phy2[1] * _rho(i, j, 3) + phy2[0] * _rho(i, j - 1, 3)) +
            phz2l[k][4] *
                (phy2[1] * _rho(i, j, 4) + phy2[0] * _rho(i, j - 1, 4)) +
            phz2l[k][5] *
        ...
        float rho2 =
            ...
            phz2l[k][1] *
                (phx2[1] * _rho(i, j, 1) + phx2[0] * _rho(i - 1, j, 1)) +
            phz2l[k][2] *
                (phx2[1] * _rho(i, j, 2) + phx2[0] * _rho(i - 1, j, 2)) +
            phz2l[k][3] *
                (phx2[1] * _rho(i, j, 3) + phx2[0] * _rho(i - 1, j, 3)) +
            phz2l[k][4] *
                (phx2[1] * _rho(i, j, 4) + phx2[0] * _rho(i - 1, j, 4)) +
            phz2l[k][5] *
