...
#define _u3(i, j, k)                                                           \
  ...
  float rho1 =
      ...
      phz4l[k][6] * (phy4[2] * _rho(i, j, 6) + phy4[0] * _rho(i, j - 2, 6) +
  ...
  float rho2 =
      ...
      phz4l[k][6] * (phx4[2] * _rho(i, j, 6) + phx4[0] * _rho(i - 2, j, 6) +
  ...
  float rho3 =
      ...
      phy4[0] *
          (phx4[2] * _rho(i, j - 2, k) + phx4[0] * _rho(i - 2, j - 2, k) +
           phx4[1] * _rho(i - 1, j - 2, k) + phx4[3] * _rho(i + 1, j - 2, k)) +
      phy4[1] *
  ...
  float rho1 =
      phz4[0] *
          (phy4[2] * _rho(i, j, k + 4) + phy4[0] * _rho(i, j - 2, k + 4) +
           phy4[1] * _rho(i, j - 1, k + 4) + phy4[3] * _rho(i, j + 1, k + 4)) +
      phz4[1] *
          (phy4[2] * _rho(i, j, k + 5) + phy4[0] * _rho(i, j - 2, k + 5) +
           phy4[1] * _rho(i, j - 1, k + 5) + phy4[3] * _rho(i, j + 1, k + 5)) +
      phz4[2] *
          (phy4[2] * _rho(i, j, k + 6) + phy4[0] * _rho(i, j - 2, k + 6) +
           phy4[1] * _rho(i, j - 1, k + 6) + phy4[3] * _rho(i, j + 1, k + 6)) +
      phz4[3] *
  ...
  float rho2 =
      phz4[0] *
          (phx4[2] * _rho(i, j, k + 4) + phx4[0] * _rho(i - 2, j, k + 4) +
           phx4[1] * _rho(i - 1, j, k + 4) + phx4[3] * _rho(i + 1, j, k + 4)) +
      phz4[1] *
          (phx4[2] * _rho(i, j, k + 5) + phx4[0] * _rho(i - 2, j, k + 5) +
           phx4[1] * _rho(i - 1, j, k + 5) + phx4[3] * _rho(i + 1, j, k + 5)) +
      phz4[2] *
          (phx4[2] * _rho(i, j, k + 6) + phx4[0] * _rho(i - 2, j, k + 6) +
           phx4[1] * _rho(i - 1, j, k + 6) + phx4[3] * _rho(i + 1, j, k + 6)) +
      phz4[3] *
...
#define _u3(i, j, k)                                                           \
  ...
  float rho1 =
      phz4r[k][7] *
          (phy4[2] * _rho(i, j, nz - 8) + phy4[0] * _rho(i, j - 2, nz - 8) +
           phy4[1] * _rho(i, j - 1, nz - 8) +
           phy4[3] * _rho(i, j + 1, nz - 8)) +
      phz4r[k][6] *
          (phy4[2] * _rho(i, j, nz - 7) + phy4[0] * _rho(i, j - 2, nz - 7) +
           phy4[1] * _rho(i, j - 1, nz - 7) +
           phy4[3] * _rho(i, j + 1, nz - 7)) +
      phz4r[k][5] *
          (phy4[2] * _rho(i, j, nz - 6) + phy4[0] * _rho(i, j - 2, nz - 6) +
           phy4[1] * _rho(i, j - 1, nz - 6) +
           phy4[3] * _rho(i, j + 1, nz - 6)) +
      phz4r[k][4] *
          (phy4[2] * _rho(i, j, nz - 5) + phy4[0] * _rho(i, j - 2, nz - 5) +
           phy4[1] * _rho(i, j - 1, nz - 5) +
           phy4[3] * _rho(i, j + 1, nz - 5)) +
      phz4r[k][3] *
          (phy4[2] * _rho(i, j, nz - 4) + phy4[0] * _rho(i, j - 2, nz - 4) +
           phy4[1] * _rho(i, j - 1, nz - 4) +
           phy4[3] * _rho(i, j + 1, nz - 4)) +
      phz4r[k][2] *
          (phy4[2] * _rho(i, j, nz - 3) + phy4[0] * _rho(i, j - 2, nz - 3) +
           phy4[1] * _rho(i, j - 1, nz - 3) +
           phy4[3] * _rho(i, j + 1, nz - 3)) +
      phz4r[k][1] *
          (phy4[2] * _rho(i, j, nz - 2) + phy4[0] * _rho(i, j - 2, nz - 2) +
           phy4[1] * _rho(i, j - 1, nz - 2) +
           phy4[3] * _rho(i, j + 1, nz - 2)) +
      phz4r[k][0] *
          (phy4[2] * _rho(i, j, nz - 1) + phy4[0] * _rho(i, j - 2, nz - 1) +
           phy4[1] * _rho(i, j - 1, nz - 1) + phy4[3] * _rho(i, j + 1, nz - 1));
  float rho2 =
      phz4r[k][7] *
          (phx4[2] * _rho(i, j, nz - 8) + phx4[0] * _rho(i - 2, j, nz - 8) +
           phx4[1] * _rho(i - 1, j, nz - 8) +
           phx4[3] * _rho(i + 1, j, nz - 8)) +
      phz4r[k][6] *
          (phx4[2] * _rho(i, j, nz - 7) + phx4[0] * _rho(i - 2, j, nz - 7) +
           phx4[1] * _rho(i - 1, j, nz - 7) +
           phx4[3] * _rho(i + 1, j, nz - 7)) +
      phz4r[k][5] *
          (phx4[2] * _rho(i, j, nz - 6) + phx4[0] * _rho(i - 2, j, nz - 6) +
           phx4[1] * _rho(i - 1, j, nz - 6) +
           phx4[3] * _rho(i + 1, j, nz - 6)) +
      phz4r[k][4] *
          (phx4[2] * _rho(i, j, nz - 5) + phx4[0] * _rho(i - 2, j, nz - 5) +
           phx4[1] * _rho(i - 1, j, nz - 5) +
           phx4[3] * _rho(i + 1, j, nz - 5)) +
      phz4r[k][3] *
          (phx4[2] * _rho(i, j, nz - 4) + phx4[0] * _rho(i - 2, j, nz - 4) +
           phx4[1] * _rho(i - 1, j, nz - 4) +
           phx4[3] * _rho(i + 1, j, nz - 4)) +
      phz4r[k][2] *
          (phx4[2] * _rho(i, j, nz - 3) + phx4[0] * _rho(i - 2, j, nz - 3) +
           phx4[1] * _rho(i - 1, j, nz - 3) +
           phx4[3] * _rho(i + 1, j, nz - 3)) +
      phz4r[k][1] *
          (phx4[2] * _rho(i, j, nz - 2) + phx4[0] * _rho(i - 2, j, nz - 2) +
           phx4[1] * _rho(i - 1, j, nz - 2) +
           phx4[3] * _rho(i + 1, j, nz - 2)) +
      phz4r[k][0] *
          (phx4[2] * _rho(i, j, nz - 1) + phx4[0] * _rho(i - 2, j, nz - 1) +
           phx4[1] * _rho(i - 1, j, nz - 1) + phx4[3] * _rho(i + 1, j, nz - 1));
