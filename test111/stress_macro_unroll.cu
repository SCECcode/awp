...
#pragma unroll
  ...
  f_dcrjy = dcrjy[j];
    ...
    vs1 = dx4[1] * _u1(i, j, k) + dx4[0] * _u1(i - 1, j, k) +
          ...
          Jii * _g_c(k) *
              (px4[0] * _f1_1(i - 1, j) *
               ...
               px4[1] * _f1_1(i, j) *
                   (phdz4[0] * _u1(i, j, k - 3) + phdz4[1] * _u1(i, j, k - 2) +
                    phdz4[2] * _u1(i, j, k - 1) + phdz4[3] * _u1(i, j, k) +
    ...
    vs2 = dhy4[2] * _v1(i, j, k) + dhy4[0] * _v1(i, j - 2, k) +
          dhy4[1] * _v1(i, j - 1, k) + dhy4[3] * _v1(i, j + 1, k) -
          Jii * _g_c(k) *
              (phy4[2] * _f2_2(i, j) *
                   (phdz4[0] * _v1(i, j, k - 3) + phdz4[1] * _v1(i, j, k - 2) +
                    phdz4[2] * _v1(i, j, k - 1) + phdz4[3] * _v1(i, j, k) +
               ...
               phy4[3] * _f2_2(i, j + 1) *
                   (phdz4[0] * _v1(i, j + 1, k - 3) +
                    ...
                    phdz4[5] * _v1(i, j + 1, k + 2) +
                    phdz4[6] * _v1(i, j + 1, k + 3)));
    vs3 = Jii * (dhz4[2] * _w1(i, j, k) + dhz4[0] * _w1(i, j, k - 2) +
    ...
    vs1 = dy4[1] * _u1(i, j, k) + dy4[0] * _u1(i, j - 1, k) +
    ...
    vs2 = dhx4[2] * _v1(i, j, k) + dhx4[0] * _v1(i - 2, j, k) +
    ...
    vs2 = dhx4[2] * _w1(i, j, k) + dhx4[0] * _w1(i - 2, j, k) +
    ...
    vs2 = dy4[1] * _w1(i, j, k) + dy4[0] * _w1(i, j - 1, k) +
