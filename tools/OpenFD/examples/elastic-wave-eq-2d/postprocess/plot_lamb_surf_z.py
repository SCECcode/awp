...
filename = lambda method, ref : 'out/lamb_surf/z_%s_%d.npz'%(method, ref)
...
t0 = delay - sat[0].t0
exact1 = helper.load_lamb_exact(time_shift=t0, nudge=3)
exact2 = helper.load_lamb_exact(time_shift=t0, nudge=0)
