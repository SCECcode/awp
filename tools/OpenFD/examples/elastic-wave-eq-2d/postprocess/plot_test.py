...
for i in range(nref+1):
    fs2.append(helper.load_data(filename('fs2_lamb_v', i, '.npz')))

sat = []
for i in range(nref+1):
    sat.append(helper.load_data(filename('sat_lamb_v', i, '.npz')))
...
plt.plot(sat[2].t, sat[2].v1[:,1], 'b')
plt.plot(sat[3].t, sat[3].v1[:,1], 'k')
plt.plot(sat[4].t, sat[4].v1[:,1], 'r')
#plt.plot(fs2[1].t, fs2[1].v1[:,1])
#plt.plot(fs2[2].t, fs2[2].v1[:,1])
plt.plot(fs2[3].t, fs2[3].v1[:,1])
plt.plot(fs2[4].t, fs2[4].v1[:,1])
